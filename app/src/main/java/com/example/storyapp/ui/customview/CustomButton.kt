...
class CustomButton : AppCompatButton {
    ...
    private var enabledBackground: Drawable =
        ContextCompat.getDrawable(context, R.drawable.success_button_ripple) as Drawable
    private var disabledBackground: Drawable =
        ContextCompat.getDrawable(context, R.drawable.success_button_disable) as Drawable

package com.example.storyapp.ui.story.ui.addstory
...
import com.example.storyapp.ui.customview.CustomEditText
import com.example.storyapp.R
import com.example.storyapp.utils.Utils.compressImageSize
import com.example.storyapp.utils.Utils.createCustomTempFile
import com.example.storyapp.utils.Utils.rotateImageIfRequired
...
class AddStoryActivity : AppCompatActivity() {
    ...
    private fun takePhoto() {
        if (!::imageCapture.isInitialized) {
            return showToast(this, getString(R.string.camera_no_Ready))
        }

package com.example.storyapp.ui.story.adapter
...
class ListItemAdapter : PagingDataAdapter<ListStoryItem, ListItemAdapter.ViewHolder>(DIFF_CALLBACK) {
    ...
    inner class ViewHolder(binding: ItemListBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        private val nameTextView: TextView = binding.tvIemName
        ...
        fun bind(story: ListStoryItem) {
            ...
            Glide.with(context)
                ...
                .thumbnail(0.1f)
                .override(600, 400)
                .placeholder(R.drawable.icon_capture)
                .error(R.drawable.icon_capture)
                .into(photoImageView)

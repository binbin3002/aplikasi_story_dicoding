...
import com.example.storyapp.ui.story.ui.detailstory.DetailStoryActivity.Companion.EXTRA_STORY_ID

@Suppress("DEPRECATION")
class ListStoryWidget : AppWidgetProvider() {

    companion object {
        private const val STORY_ACTION = "com.example.storyapp.STORY_ACTION"
